...
- «ℹ️ Клуб» → показывает описание клуба и открывает подменю с поддержкой, материалами, обучением, оплатой и FAQ.【F:keyboards.py†L180-L215】【F:handlers/menu.py†L145-L212】
...
- «🧪 Пройти тест» → запуск теста и переход к анкете.【F:keyboards.py†L186-L205】【F:handlers/__init__.py†L8086-L8128】
- «📘 Забрать гайд» → выдаёт ссылку на гайд из контента админки.【F:keyboards.py†L186-L205】【F:handlers/menu.py†L235-L255】
- «🗓️ Записаться на разбор» → оформление заявки на персональный разбор.【F:keyboards.py†L186-L205】【F:handlers/__init__.py†L7960-L8058】
- «✨ Окно в Магнетизм» → переход к форме «Окно в Магнетизм».【F:keyboards.py†L186-L205】【F:handlers/menu.py†L400-L418】
