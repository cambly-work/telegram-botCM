...
| --- | --- | --- | --- | --- |
| Выбор сегмента | `AdminUserStates.choosing_segment` | Админ нажимает на кнопку сегмента в меню «👥 Пользователи» | `AdminUserStates.browsing_users` | Бот показывает первую страницу списка участниц выбранного сегмента с пагинацией. 【F:handlers.py†L5414-L5435】 |
...
1. Админ открывает «👥 Пользователи» → выбирает сегмент → карточку участницы.
